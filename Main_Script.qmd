...
In this paper, we will investigate the intermediary asset pricing model proposed by Sa Mai (2023) where a semi parametric approach was used in to model the heterogenenous intermediary stochastic discount factor (HI-SDF)
